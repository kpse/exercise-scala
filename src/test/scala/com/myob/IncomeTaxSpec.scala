...
class IncomeTaxSpec extends Specification {
  ...
  The IncomeTax should
    ...
    report error if input is out of range                         $reportErrorWhenOutOfRange
    report error if input is invalid                              $reportNothing
